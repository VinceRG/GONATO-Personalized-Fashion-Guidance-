...
.info-card { background:#f9f9f9; border-radius:var(--radius-large); padding:1.5rem; transition:0.3s; margin-top:1rem; }
.info-card:hover { background: var(--color-primary-light); transform:translateY(-2px); }
.info-card-header { display:flex; align-items:center; gap:0.75rem; margin-bottom:1rem; color:var(--color-accent-dark); }
.info-card-header i { font-size:1.5rem; color:var(--color-accent); }
.info-card-header h3 { font-size:1.1rem; font-weight:600; }
.info-item { display:flex; justify-content:space-between; padding:0.5rem 0; border-bottom:1px solid rgba(0,0,0,0.05); }
.info-item:last-child { border-bottom:none; }
.info-label { color:#666; font-size:0.9rem; }
.info-value { color:var(--color-accent-dark); font-weight:500; font-size:0.9rem; }
