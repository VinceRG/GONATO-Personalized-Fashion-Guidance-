    ...
    <div class="modal">
      ...
      <div class="modal-body">
         ...
         <div id="purchases-view" style="display: none;">
            ...
            <div class="sub-tabs">
                <button class="sub-tab-btn active" data-subtab="orders">Active Orders</button>
                <button class="sub-tab-btn" data-subtab="history">Order History</button>
            </div>

            <!-- SUB TAB CONTENT: ACTIVE ORDERS -->
